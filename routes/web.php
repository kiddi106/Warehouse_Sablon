...
Route::resource('/dashboard/transaction', DashboardTransaction::class)->middleware('auth');
// menonaktifkan show

Route::resource('/dashboard/categories', AdminCategoryController::class)->except('show');

// Report PDF
Route::get('/downloadpdf/{transaction}',[DashboardTransaction::class, 'downloadpdf'] );
